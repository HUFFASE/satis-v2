          ...
          <Table>
            <TableHeader className="bg-slate-50 dark:bg-slate-800/50">
              <TableRow>
                ...
                <TableHead className="text-right font-semibold text-slate-700 dark:text-slate-300">Revenue Hedefi (USD)</TableHead>
                <TableHead className="text-right font-semibold text-slate-700 dark:text-slate-300">GP Hedefi (USD)</TableHead>
